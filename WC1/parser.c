...
#line 39 "parser.y"
{ yygotominor.yy12 = make_redir(yymsp[0].minor.yy12, 1, 0, yymsp[-1].minor.yy0.number, 0); free(yymsp[-1].minor.yy0.text);   yy_destructor(yypParser,5,&yymsp[-3].minor);
...
#line 43 "parser.y"
{ yygotominor.yy12 = make_redir(yymsp[0].minor.yy12, -1, 0, yymsp[-1].minor.yy0.number, 0); free(yymsp[-1].minor.yy0.text);   yy_destructor(yypParser,4,&yymsp[-4].minor);
...
#line 45 "parser.y"
{ yygotominor.yy12 = make_redir(yymsp[0].minor.yy12, yymsp[-4].minor.yy0.number, 0, yymsp[-1].minor.yy0.number, 0); free(yymsp[-1].minor.yy0.text); free(yymsp[-4].minor.yy0.text);   yy_destructor(yypParser,5,&yymsp[-3].minor);
  yy_destructor(yypParser,4,&yymsp[-2].minor);
}
#line 878 "parser.c"
        break;
...
#line 46 "parser.y"
{ yygotominor.yy12 = make_redir(yymsp[0].minor.yy12, yymsp[-3].minor.yy0.number, 2, 0, yymsp[-1].minor.yy0.text); free(yymsp[-3].minor.yy0.text);   yy_destructor(yypParser,5,&yymsp[-2].minor);
}
#line 884 "parser.c"
        break;
      case 20: /* redir ::= NUMBER GT GT WORD redir */
#line 47 "parser.y"
{ yygotominor.yy12 = make_redir(yymsp[0].minor.yy12, yymsp[-4].minor.yy0.number, 3, 0, yymsp[-1].minor.yy0.text); free(yymsp[-4].minor.yy0.text);   yy_destructor(yypParser,5,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-2].minor);
}
#line 891 "parser.c"
        break;
...
#line 48 "parser.y"
{ yygotominor.yy12 = make_redir(yymsp[0].minor.yy12, yymsp[-3].minor.yy0.number, 1, 0, yymsp[-1].minor.yy0.text); free(yymsp[-3].minor.yy0.text);   yy_destructor(yypParser,8,&yymsp[-2].minor);
}
#line 897 "parser.c"
        break;
